    ...
    <section class="section">
      <div class="container container-narrow">
        ...
        <div style="background:var(--bg-card); padding:var(--space-2xl); border-radius:var(--radius-lg); box-shadow:var(--shadow-sm); margin-bottom:var(--space-2xl);">
          <h2 style="font-size:var(--fs-2xl); margin-bottom:var(--space-md); border-bottom:2px solid var(--color-peach-protein); padding-bottom:var(--space-xs);">Privacy Policy Summary</h2>
        ...
        <div style="background:var(--bg-card); padding:var(--space-2xl); border-radius:var(--radius-lg); box-shadow:var(--shadow-sm);">
          <h2 style="font-size:var(--fs-2xl); margin-bottom:var(--space-md); border-bottom:2px solid var(--color-peach-protein); padding-bottom:var(--space-xs);">Terms & Conditions Guidelines</h2>
